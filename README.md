...
* **Branch and Bound:** An integer programming solver using the [Branch and Bound algorithm](https://en.wikipedia.org/wiki/Branch_and_bound) and utilizing [CPLEX](https://www.ibm.com/products/watsonx-ai?p1=Search&p4=43700079741557975&p5=e&p9=58700008686403551&gad_campaignid=20116653496&gbraid=0AAAAAD-_QsRfu2ShV_SoY3t4SkfA6aJ9n) as an linear programming solver for the lower bound.
